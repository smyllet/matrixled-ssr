...
const routes = {
  ...
  'devices.patch': {
    ...
    pattern: '/api/v1/devices/:id',
    tokens: [{"old":"/api/v1/devices/:id","type":0,"val":"api","end":""},{"old":"/api/v1/devices/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/devices/:id","type":0,"val":"devices","end":""},{"old":"/api/v1/devices/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['devices.patch']['types'],
  },
  'devices.delete': {
    methods: ["DELETE"],
    pattern: '/api/v1/devices/:id',
  ...
  'device.bootstrap': {
    ...
    tokens: [{"old":"/api/v1/device/bootstrap","type":0,"val":"api","end":""},{"old":"/api/v1/device/bootstrap","type":0,"val":"v1","end":""},{"old":"/api/v1/device/bootstrap","type":0,"val":"device","end":""},{"old":"/api/v1/device/bootstrap","type":0,"val":"bootstrap","end":""}],
    types: placeholder as Registry['device.bootstrap']['types'],
  },
  'event_stream': {
    methods: ["GET","HEAD"],
